...
Hátra a Mászónapló-alkörből: M3 (admin frontend), M4–M7 (a 4 kontextus-napló),
M8 (mászó statisztikák + `edzes.maszonaplo` aktiválás + `climbingKcalForDay` a Kaja
dashboardba).
