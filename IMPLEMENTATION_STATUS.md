...
| Feature / Subfeature | Spec commit | Backend | Frontend | Megjegyzés |
|---|---|---|---|---|
| [Kaja](documentation/Features/Kaja.md) | `3b4564f` (2026-08-19) | — | — | Csak a hub navigáció; a subfeature-ök közül eddig egy sincs teljesen kész, lásd alul. |
...
|---|---|---|
| ↳ Kaja folytatása | Élelmiszer tárolás → Recept → Tápérték kalkulátor → Étkezés (+3 forrás) → Kaja statisztika (javasolt sorrend, lásd a "Folyamatban" szakaszt fent a már kész Élelmiszerek-körért — katalógus + mindhárom hozzáadási csatorna) | Lásd fent |
