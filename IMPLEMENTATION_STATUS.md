...
Hátra a Mászónapló-alkörből: M3b (outdoor törzsadat admin frontend — `Crag` → `Sector` →
`Route` | `BoulderProblem`), M4–M7 (a 4 kontextus-napló), M8 (mászó statisztikák +
