...
| Feature / Subfeature | Spec commit | Backend | Frontend | Megjegyzés |
|---|---|---|---|---|
| [Kaja](documentation/Features/Kaja.md) | `3b4564f` (2026-08-19) | — | — | Csak a hub navigáció; a subfeature-ök közül eddig kettő (Élelmiszerek, Élelmiszer tárolás) kész a maga körében, a többi hátravan — lásd alul. |
...
|---|---|---|
| ↳ Kaja folytatása | Recept → Tápérték kalkulátor → Étkezés (+3 forrás, ez zárja le a Bevásárlásból + fogyasztási cascade-ot az Élelmiszer tárolásnál) → Kaja statisztika (javasolt sorrend, lásd a "Folyamatban" szakaszt fent a már kész Élelmiszerek + Élelmiszer tárolás körökért) | Lásd fent |
