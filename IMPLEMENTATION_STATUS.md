...
| Feature / Subfeature | Spec commit | Backend | Frontend | Megjegyzés |
|---|---|---|---|---|
| [Kaja](documentation/Features/Kaja.md) | `3b4564f` (2026-08-19) | — | — | Csak a hub navigáció; a subfeature-ök közül eddig négy (Élelmiszerek, Élelmiszer tárolás, Recept, Tápérték kalkulátor) kész a maga körében, az Étkezés adatréteg+CRUD-ja is kész (dashboard/progress bar hátravan), a többi hátravan — lásd alul. |
...
|---|---|---|
| ↳ Kaja folytatása | Étkezés dashboard (6b: progress bar-ok + cél-vizualizáció, lásd a "Folyamatban" szakaszban az Étkezés sort a már kész adatréteg+CRUD+készletlevonás körért) → Kaja statisztika (javasolt sorrend, lásd a "Folyamatban" szakaszt fent a már kész Élelmiszerek + Élelmiszer tárolás + Recept + Tápérték kalkulátor + Étkezés (adatréteg) körökért) | Lásd fent |
