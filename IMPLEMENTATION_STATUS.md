...
| Feature / Subfeature | Spec commit | Backend | Frontend | Megjegyzés |
|---|---|---|---|---|
| [Kaja](documentation/Features/Kaja.md) | `3b4564f` (2026-08-19) | — | — | Csak a hub navigáció; a subfeature-ök közül öt (Élelmiszerek, Élelmiszer tárolás, Recept, Tápérték kalkulátor, Étkezés) kész a maga körében, a Kaja statisztika hátravan — lásd alul. (A Bevásárlás a Kaja domainben kapcsolódik, de önálló feature a Menü tab alatt — mindhárom subfeature-je kész, lásd lent.) |
...
|---|---|---|
| ↳ Kaja folytatása | Kaja statisztika (a Kaja tab alatti utolsó hátralévő subfeature — lásd a "Folyamatban" szakaszt fent a már kész Élelmiszerek + Élelmiszer tárolás + Recept + Tápérték kalkulátor + Étkezés körökért — Étkezés 6a+6b is teljes; a Bevásárlás mindhárom subfeature-je is kész, lásd fent) | Lásd fent |
