...
describe('FoodListPage', () => {
  ...
  let repository: jasmine.SpyObj<Pick<FoodRepository, 'load' | 'remove' | 'countReferences'>> & {
  ...
  beforeEach(async () => {
    repository = jasmine.createSpyObj('FoodRepository', ['load', 'remove', 'countReferences']) as never;
