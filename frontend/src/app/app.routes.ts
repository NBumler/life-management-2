    ...
    children: [
      {
        ...
        children: [
            ...
            children: [
              {
                path: '',
                loadComponent: () =>
                  import('./pages/menu/finance/finance-dashboard.page').then((m) => m.FinanceDashboardPage),
              },
              {
                path: 'net-pay',
          ...
          },
          {
            ...
            // on the tree top guards the index route and every child (the `finance` pattern).
            path: 'aycm',
            ...
            children: [
              {
                path: '',
                loadComponent: () =>
                  import('./pages/menu/aycm/aycm-dashboard.page').then((m) => m.AycmDashboardPage),
              },
              {
                path: 'partners',
                children: [
